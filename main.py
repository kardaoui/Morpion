...
class Jeu:
    ...
    def alignement(self):  # verification de l'allignement des symboles
        ...
        # verification de l'allignement des symboles (ligne et diagonal)
        for i in range(0, 3):
        ...
        if self.df_case.iat[0, 0] == self.df_case.iat[1, 1] == self.df_case.iat[2, 2] == self.joueur:
            print("ok", self.joueur)
        if self.df_case.iat[0, 2] == self.df_case.iat[1, 1] == self.df_case.iat[2, 0] == self.joueur:
            print("ok", self.joueur)
